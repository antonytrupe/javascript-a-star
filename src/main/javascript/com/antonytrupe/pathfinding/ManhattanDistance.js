...
function ManhattanDistance(_state, goal) {
	...
	this.getActions = function() {
		// console.log('ManhattanDistance.getActions this._state.position');
		// console.log(this._state.position);
		var actions = [];
		for (var x = -1; x <= 1; x++) {
			// console.log(x);
			...
			if (this._state.position.x + x >= 0
				...
				for (var y = -1; y <= 1; y++) {
					// console.log('this.position.y + y >= 0:'
					// + (this._state.position.y + y >= 0));
					// console
					// .log('this.position.y + y < map[this.position.x +
					// x].length:'
					// + (this._state.position.y + y <
					// this._state.map[this._state.position.x
					// + x].length));
					// bounds check y
	...
	this.atGoal = function() {
		// console.log('ManhattanDistance.atGoal');
